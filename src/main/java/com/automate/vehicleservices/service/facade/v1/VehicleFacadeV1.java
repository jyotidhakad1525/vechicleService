...
import com.automate.vehicleservices.api.model.VehicleInsuranceDetails;
...
public class VehicleFacadeV1 {
    ...
    public VehicleFacadeV1(ServiceVehicleService serviceVehicleService, CustomerFacade customerFacade,
     ...
     * @return
     */
    public ServiceVehicle fetchOrCreateServiceVehicleEntity(VehicleDetailsV1 vehicleDetails, Customer customer,
                                                            MdTenant mdTenant) {
    ...
    public void addVehicleTrackerEntity(ServiceVehicle serviceVehicle, VehicleDetailsV1 vehicleDetails) {
     ...
     * @return
     */
    private ServiceVehicle createServiceVehicleEntity(VehicleDetailsV1 vehicleDetails, Customer customer,
                                                      MdTenant mdTenant) {
        ...
        ServiceVehicle serviceVehicle = ServiceVehicleBuilder.aServiceVehicle()
                ...
                .withCurrentKmReading(vehicleDetails.getCurrentKmReading())
                .withPurchaseDate(vehicleDetails.getPurchaseDate())
                .withMakingMonth(vehicleDetails.getMakingMonth())
                .withMakingYear(vehicleDetails.getMakingYear())
                ...
                .withIsFastag(vehicleDetails.getIsFastag())
...
//    }
    ...
    public ServiceVehicle fetchOrUpdateServiceVehicleEntity(VehicleDetailsV1 vehicleDetails, Customer customer, MdTenant mdTenant) {
        ...
        vehicleWithRegNumber = createServiceVehicleEntity(vehicleDetails, customer, mdTenant);
        vehicleWithRegNumber.setId(vehicleDetails.getId());
